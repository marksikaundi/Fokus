...
export function PowerConsumptionChart({ 
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Chart area */}
      <View style={[styles.chartArea, { height, backgroundColor: colorScheme === 'dark' ? '#1a1a1a' : '#f5f5f5' }]}>
        {/* Grid lines */}
        <View style={[styles.gridLine, { top: '25%', borderTopColor: colors.icon }]} />
        <View style={[styles.gridLine, { top: '50%', borderTopColor: colors.icon }]} />
        <View style={[styles.gridLine, { top: '75%', borderTopColor: colors.icon }]} />
      ...
      <View style={styles.xAxisLabels}>
        {data.map((d, i) => (
          <Text key={`time-${i}`} style={[styles.xLabel, { color: colors.icon }]}>
            {d.time}
          </Text>
        ))}
      </View>
      ...
      <View style={styles.legend}>
        <View style={styles.legendItem}>
          ...
          <Text style={[styles.legendText, { color: colors.text }]}>Standby</Text>
        </View>
        <View style={styles.legendItem}>
