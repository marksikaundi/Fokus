  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        <ThemedText type="title" style={styles.headerTitle}>Go Power</ThemedText>
        ...
        {features.map((feature, index) => (
          ...
          >
            <View style={[
              styles.featureItem,
              {
                borderBottomColor: index !== features.length - 1 ? (colorScheme === 'dark' ? '#2a2a2a' : '#e0e0e0') : 'transparent',
              },
            ]}>
              <View 
                style={[
