...
export default function WorkScreen() {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.phoneCard, { backgroundColor: FokusColors.white }]}>
        ...
        <View style={styles.content}>
          <View style={styles.centerBlock}>
            ...
            <ThemedText
              style={styles.title}
              lightColor={FokusColors.textWork}
              darkColor={FokusColors.textWork}
            >
              Work Mode
            </ThemedText>
            <ThemedText
              ...
              darkColor={FokusColors.textWork}
            >
              Clear distractions and focus on a single task.
            </ThemedText>
          </View>
          ...
          >
            <Pressable
              ...
              accessibilityLabel="Back to timer"
            >
              <Ionicons name="play" size={30} color={FokusColors.white} />
            </Pressable>
...
const styles = StyleSheet.create({
  ...
  mainButton: {
    ...
    justifyContent: "center",
    alignItems: "center",
    backgroundColor: FokusColors.sage,
    shadowColor: "#000",
